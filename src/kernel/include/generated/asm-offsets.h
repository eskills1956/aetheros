...
#define THREAD_SCTLR_USER 4448 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 4344 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 4424 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 4440 /* offsetof(struct task_struct, thread.mte_ctrl) */
